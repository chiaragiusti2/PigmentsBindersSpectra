...
async function renderPigment() {
  ...
  for (const instrument of instruments) {
    ...
    desc.textContent = siteContent.instruments?.[instrument] || siteContent.pigmentsMap?.[pigment]?.instruments?.[instrument]?.description || '';
...
function updateInfo() {
  ...
  document.getElementById('pigmentName').textContent = siteContent.pigmentsMap?.[p]?.title || p;
  document.getElementById('pigmentDesc').textContent =
    siteContent.pigmentsMap?.[p]?.description || '';
